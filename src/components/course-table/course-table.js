    ...
    render() {
        return(
            ...
            <div style={{marginTop: "0px", padding: "15px"}}>
                <div className="row" style={{fontWeight:"bold", fontSize: "1em", borderBottom: "1px solid #aaaaaa", borderTop: "1px solid #aaaaaa", padding: "5px"}}>
                    <div className="col-4 col-md-7 col-lg-6">Title</div>
